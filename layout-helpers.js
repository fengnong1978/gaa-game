...
const LayoutHelpers = {
    ...
    normalizeBackground(bg) {
        const b = bg || {};
        const fitPanX = b.fitPanX != null ? b.fitPanX : b.offsetX != null ? b.offsetX : 0;
        const fitPanY = b.fitPanY != null ? b.fitPanY : b.offsetY != null ? b.offsetY : 0;
        ...
        if (scene.characterRef && projectData && projectData.characterRoster) {
            ...
            if (c && c.expressions) {
                ...
                if (slot && slot.spriteAsset) {
                    ...
                    return typeof AssetManager !== 'undefined' && AssetManager.getPath
